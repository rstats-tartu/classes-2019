...
Numerical summaries, like arithmetic mean or correlation coeficient, can be deciving when shape of the data is not known or shown, think of average salary or **datasaurus**.
...
![](01-visualization_files/figure-markdown_github/unnamed-chunk-14-1.png) Maybe this plot explains why it's generally not a good idea to map categorical variable to size aesthetic.
...
![](01-visualization_files/figure-markdown_github/unnamed-chunk-20-1.png) To specify name of a variable precede it by ~
