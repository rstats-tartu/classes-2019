...
Note that the variables, used for splitting up data and arranging facets row and columnwise, are specified in facet_grid() by formula: facet_grid(rows ~ columns).
