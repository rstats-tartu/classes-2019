...
We can try to put different countries side-by-side by using small subplots. Series of small subplots (multiples) use same scale and axes allowing easier comparisons. Fortunately, ggplot has easy way to do this: facet_wrap() and facet_grid() functions split up your dataset and generate multiple small plots arranged in an array. 
