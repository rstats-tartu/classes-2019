...
For example, let's consider **gapmider** dataset on life expectancy, GDP per capita, and population by country. We want to plot life expectancy versus GDP per capita
