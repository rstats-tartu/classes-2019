...
If plot creation is successful, you can see negative relationship between engine size and fuel consumption (miles per gallon). It's probably no news to anyone that cars with big engines use more fuel.
